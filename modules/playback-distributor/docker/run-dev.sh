...
# Usage:
#
# ./modules/playback-distributor/docker/run-dev.sh [... extra args to pass to docker run command]
#
...
docker run \
  ...
  --tty \
  --interactive \
  --volume $TACONEZ_ROOT/modules/playback-distributor/src:/app/playback-distributor/src \
  --volume $TACONEZ_ROOT/modules/playback-distributor/CMakeLists.txt:/app/playback-distributor/CMakeLists.txt \
  --volume $TACONEZ_ROOT/modules/playback-distributor/tests:/app/playback-distributor/tests \
