...
export const protobufPackage = "grpc_definition";
...
export const GreeterService = {
  /** Sends a greeting */
  sayHello: {
    path: "/grpc_definition.Greeter/SayHello",
    requestStream: false,
...
export const GreeterClient = makeGenericClientConstructor(GreeterService, "grpc_definition.Greeter") as unknown as {
